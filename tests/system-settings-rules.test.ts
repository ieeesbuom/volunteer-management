...
describe("system settings rules", () => {
  it("formats IEEE term labels from the start year", () => {
    expect(formatTermLabel("2025-10-01")).toBe("25/26");
    expect(formatTermLabel("2024-08-16")).toBe("24/25");
    expect(normalizeIeeeTermLabel("2025/26")).toBe("25/26");
    expect(normalizeIeeeTermLabel("2025/2026")).toBe("25/26");
    expect(() => assertValidTermLabel("25/26", "2025-10-01")).not.toThrow();
